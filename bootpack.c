...
void HariMain(void)
{
    ...
    memman_init(memman);
    memman_free(memman, 0x00001000, 0x0009e000); /* 0x00001000 - 0x009efff */
    ...
    *((int *) (task_cons->tss.esp + 8)) = (int) memtotal;
    ...
    sheet_setbuf(sht_mouse, buf_mouse, 16, 16, 99); /* 透明色番号は９９ */
	...
	for (;;) {
        ...
        if (fifo32_status(&fifo) == 0) {
            ...
            if (256 <= i && i <= 511) { /* キーボードデータ */
                ...
                if (i == 256 + 0x3b && key_shift != 0 && task_cons->tss.ss0 != 0) { /* Shift+fn+F1 */
